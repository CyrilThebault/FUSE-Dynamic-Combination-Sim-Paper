...
#!
#! Creation date     : 2024-11-23 14:29:18
#! Modification date :
#!
#! Comments          :
#!
...
models = apply(read.table(file.path(dir_FUSE,"list_WA_1000.txt"), header = TRUE, sep = ";"), 1, function(row) paste(row, collapse = "_"))
...
for(id in 1:nrow(mydf)){
  ...
  dir_catchment= file.path(dir_merge, dataset, spatialisation, inputdata,CritCal, outputfolder, catchment)

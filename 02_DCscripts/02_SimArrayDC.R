...
for(catchment in catchments){
  ...
  for(decision in decisionsID){
    ...
    SIM_path = file.path(FUSE_path, dataset, spatialisation, inputdata, CritCal, outputfolder, catchment, "output")
...
save(Qsim_array, file = file.path(FUSE_path, dataset, spatialisation, inputdata, CritCal, outputfolder, "SimArray.Rdata"))
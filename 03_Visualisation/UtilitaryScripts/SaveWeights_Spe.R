...
base_path <- "/work/comphyd_lab/users/cyril.thebault/Postdoc_Ucal/02_DATA/FUSE/CAMELS/Lumped/daymet/KGE/WA_WA_q"

paramset_name <- "16_17_5"
...
final_array <- array(NA, dim = c(length(catchments), length(DatesR), length(models_tot)))
